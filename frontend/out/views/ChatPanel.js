...
class ChatPanel {
    constructor(panel, extensionUri, chatService) {
        this.disposables = [];
        this.messages = [];
        this.panel = panel;
    ...
    static createOrShow(extensionUri, chatService) {
        ...
        const panel = vscode.window.createWebviewPanel('codeImproverChat', 'AI Assistant', column || vscode.ViewColumn.Two, {
            enableScripts: true,
...
You can also select code in your editor and ask me about it directly!`,
    ...
    async detectAndHandleFileReferences(content, codeContext) {
    ...
    sanitizeFileReference(fileReference) {
    ...
    async findFileCaseInsensitive(reference, workspaceFolders) {
...
<body>
   ...
   <script nonce="${nonce}">
    ...
    async addContentToContext(contentType) {
